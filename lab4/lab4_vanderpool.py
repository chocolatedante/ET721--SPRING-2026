...
print(f"updated dictionary wirth new pair = {contacts}")


print("\n---Exampkle 2: Loop through a dictionary---")
...
#items method returns all the key-values in the dictionary
...
#can be used to uopdate a value of a key or to add a new key-value pair
